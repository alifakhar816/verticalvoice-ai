...
This Code of Conduct applies within all community spaces for the
VerticalVoice AI project (this repository's Issues, Pull Requests,
Discussions, and any associated project communication channels), and
...
be reported by opening a private security advisory for this repository
(**Security tab → Report a vulnerability**, or
https://github.com/alifakhar816/verticalvoice-ai/security/advisories/new),
which is only visible to maintainers, or by contacting the project's
